...
pub(crate) static RANDOM_BLUR_STATE: LazyLock<Mutex<crate::rndblur::unoptimized::RandomBlurState>> =
    LazyLock::new(|| Mutex::new(crate::rndblur::unoptimized::RandomBlurState::new()));
