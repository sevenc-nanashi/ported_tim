--label:${ROOT_CATEGORY}\配置\@モーションパスD
...
for i = 0, T_MP_SECTION_COUNT - 1 do
    T_MP_X_POSITIONS[i] = obj.getvalue("track.track_r_coord", 0, i)
    T_MP_Y_POSITIONS[i] = obj.getvalue("track.track_theta_coord", 0, i)
    T_MP_Z_POSITIONS[i] = obj.getvalue("track.track_phi_coord", 0, i)
    T_MP_TWISTS[i] = obj.getvalue("track.track_twist", 0, i)
end

T_MP_X_POSITIONS[T_MP_SECTION_COUNT] = obj.getvalue("track.track_r_coord", 0, -1)
T_MP_Y_POSITIONS[T_MP_SECTION_COUNT] = obj.getvalue("track.track_theta_coord", 0, -1)
T_MP_Z_POSITIONS[T_MP_SECTION_COUNT] = obj.getvalue("track.track_phi_coord", 0, -1)
