--label:モーションパスB.anm\\MP-B3
---$track:R座標
---min=0
---max=10000
---step=0.1
local track_r_coord_3 = 100

---$track:θ座標
---min=-1800
---max=1800
---step=0.1
local track_theta_coord_3 = 0

---$track:φ座標
---min=-3600
---max=3600
---step=0.1
local track_phi_coord_3 = 0
...
ZZ[0] = 0
TW[0] = STW
XX[1] = track_r_coord_3
YY[1] = track_theta_coord_3
ZZ[1] = track_phi_coord_3
TW[1] = track_twist_3
NN = 1
...
NN = NN + 1
XX[NN] = track_r_coord_3
YY[NN] = track_theta_coord_3
ZZ[NN] = track_phi_coord_3
TW[NN] = track_twist_3
