...
AviUtl1から2の更新点として、スクリプト内でのシェーダー記法の追加や、drawpolyのバッチ対応など、パフォーマンスを向上させるための機能が追加されました。
...
また、シェーダー化において、元コードの構造を完全に再現する必要はありません。
特にRGBを256諧調で扱う挙動の再現をする必要はありません（むしろ速度・HDR対応において不利になることが多い）。
